package cn.com.twoke.game.tank.components.bullet;
...
public class BulletComponent extends Component {
    ...
    private void initBullet() {
        // 默认是右边
        BufferedImage originBulletImage = AssetPool.loadTexture("/textures/bullet/normal.png");
        int deg = 0;
        offsetX = 0;
        offsetY = 0;
        switch (dir) {
        ...
        bulletImage = ImageUtil.rotateImage(originBulletImage, deg);
